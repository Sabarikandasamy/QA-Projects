...
public class Lab090_HackerRank_Q2 {
    public static void main(String[] args) {
        ...
        //if Side 1 = = Side 2 and Side 2 == Side3 -> side 1 == side 3- Eq
        // side 1 == side 2 || side 1 == side 3 || side 2 == side 3 --> iso
        // else -> Scalene
        if (side1 <= 0 || side2 <= 0 || side3 <= 0) {
            System.out.println("Invalid input: side lengths must be positive. "); // Parent loop
        } else {

            if (side1 == side2 && side2 == side3 && side1 == side3) {
                System.out.println("The triangle is equilateral.");
            } else if (side1 == side2 || side1 == side3 || side2 == side3) {
                System.out.println("The triangle is iso");
            } else {
